...
// ProcessUprEventForFiltering provides a mock function with given fields: uprEvent, dp
func (_m *UtilsIface) ProcessUprEventForFiltering(uprEvent *memcached.UprEvent, dp utils.DataPoolIface) ([]byte, error, utils.ReleaseMemFunc) {
	ret := _m.Called(uprEvent, dp)

	var r0 []byte
	if rf, ok := ret.Get(0).(func(*memcached.UprEvent, utils.DataPoolIface) []byte); ok {
		r0 = rf(uprEvent, dp)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]byte)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(*memcached.UprEvent, utils.DataPoolIface) error); ok {
		r1 = rf(uprEvent, dp)
	} else {
		r1 = ret.Error(1)
	}
	...
	if rf, ok := ret.Get(2).(func(*memcached.UprEvent, utils.DataPoolIface) utils.ReleaseMemFunc); ok {
		r2 = rf(uprEvent, dp)
	} else {
		if ret.Get(2) != nil {
