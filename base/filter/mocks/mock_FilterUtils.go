...
func (_m *FilterUtils) CheckForNecessarySystemXattrsInUprEvent(uprEvent *memcached.UprEvent, dp base.DataPool, slicesToBeReleased *[][]byte, needToFilterBody bool) (bool, bool, []byte, int, error, string, int64, []byte) {
...
// FilterUtils_CheckForNecessarySystemXattrsInUprEvent_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CheckForNecessarySystemXattrsInUprEvent'
type FilterUtils_CheckForNecessarySystemXattrsInUprEvent_Call struct {
	*mock.Call
}
...
func (_e *FilterUtils_Expecter) CheckForNecessarySystemXattrsInUprEvent(uprEvent interface{}, dp interface{}, slicesToBeReleased interface{}, needToFilterBody interface{}) *FilterUtils_CheckForNecessarySystemXattrsInUprEvent_Call {
	return &FilterUtils_CheckForNecessarySystemXattrsInUprEvent_Call{Call: _e.mock.On("CheckForNecessarySystemXattrsInUprEvent", uprEvent, dp, slicesToBeReleased, needToFilterBody)}
}

func (_c *FilterUtils_CheckForNecessarySystemXattrsInUprEvent_Call) Run(run func(uprEvent *memcached.UprEvent, dp base.DataPool, slicesToBeReleased *[][]byte, needToFilterBody bool)) *FilterUtils_CheckForNecessarySystemXattrsInUprEvent_Call {
...
func (_c *FilterUtils_CheckForNecessarySystemXattrsInUprEvent_Call) Return(hasTxnXattr bool, hasConflictLoggingXattr bool, body []byte, endBodyPos int, err error, additionalErrDesc string, totalFailedCnt int64, uncompressedUprValue []byte) *FilterUtils_CheckForNecessarySystemXattrsInUprEvent_Call {
...
func (_c *FilterUtils_CheckForNecessarySystemXattrsInUprEvent_Call) RunAndReturn(run func(*memcached.UprEvent, base.DataPool, *[][]byte, bool) (bool, bool, []byte, int, error, string, int64, []byte)) *FilterUtils_CheckForNecessarySystemXattrsInUprEvent_Call {
	_c.Call.Return(run)
	return _c
}
